...
<div align= "center"><img src="assets/health.webp" width="250" height="250"/>
  <h4> Heart Disease Prediction System built with Keras/Tensorflow using Deep Learning Neural Networks by applying multiple Deep Learning Algorithms to give the best model. It can predict if the person is suffering from heart disease or not by taking some input data values.</h4>
</div>
